...
<div id = "board">
	...
	<form method="post" action="${cp }/admin/product/productUpdate" 
		...
		<table border = "1" style="width: 500px;">
			...
			<tr>
				<td>상품명</td>
				<td><input type = "text" name = "name" value = "${vo.prod_name }"></td>
			</tr>
			<tr>
				<td>가격</td>
				<td><input type = "text" name = "price" value = "${vo.prod_price }"></td>
			</tr>
			<tr>
				<td>옵션</td>
				<td>
					<input type = "button" value = "옵션추가" id = "btnAdd" onclick="addDivOp()" style = "display: none;">
					<div id = "op">
