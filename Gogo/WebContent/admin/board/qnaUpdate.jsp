              ...
              <div class="p-5 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <input type = "text" name = "title" id = "title" class="form-control" value = "${vo.qna_title }">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="content" class="text-black">내용 </label>
                    <textarea name="content" id="content" cols="30" rows="7" class="form-control">${vo.qna_content }</textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input type = "password" name = "pwd" id = "pwd" class="form-control" disabled="disabled">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-lg-6">
