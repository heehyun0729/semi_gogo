...
<div id="board">
	<div>
		...
		<input type="button" value="수정" onclick="location.href='${cp }/board/noticeUpdate.do?menu_num=${menu_num}&notice_num=${nvo.notice_num }'">
		<input type="button" value="삭제" onclick="location.href='${cp }/board/noticeDelete.do?menu_num=${menu_num}&notice_num=${nvo.notice_num }'">
		</div>
	</div>
</div>